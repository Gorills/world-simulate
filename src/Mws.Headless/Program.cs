...
static void RunSettlement(string[] args)
{
    ...
    Console.WriteLine($"MWS_SETTLEMENT_OK days={days} day={projection.Day} hour={projection.Hour} residents={projection.Residents.Count} pantry={projection.PantryRations} events={projection.RecentEvents.Count}");
}
